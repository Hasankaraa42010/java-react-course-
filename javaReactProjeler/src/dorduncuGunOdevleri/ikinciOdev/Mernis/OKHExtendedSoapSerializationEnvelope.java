...
public class OKHExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OKHDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OKHStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OKHDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OKHDateTimeConverter dateTimeConverter = new OKHStandardDateTimeConverter();

    public OKHExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OKHExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OKHMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OKHHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OKHExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OKHHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
