...
public class OKHKPSPublicSoap
{
    ...
    public OKHKPSPublicSoap(){}

    public OKHKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OKHKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OKHExtendedSoapSerializationEnvelope envelope= new OKHExtendedSoapSerializationEnvelope(OKHExtendedSoapSerializationEnvelope.VER11);
