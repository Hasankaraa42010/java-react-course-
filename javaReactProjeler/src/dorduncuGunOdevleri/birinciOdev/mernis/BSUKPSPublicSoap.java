...
public class BSUKPSPublicSoap
{
    ...
    public BSUKPSPublicSoap(){}

    public BSUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public BSUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        BSUExtendedSoapSerializationEnvelope envelope= new BSUExtendedSoapSerializationEnvelope(BSUExtendedSoapSerializationEnvelope.VER11);
