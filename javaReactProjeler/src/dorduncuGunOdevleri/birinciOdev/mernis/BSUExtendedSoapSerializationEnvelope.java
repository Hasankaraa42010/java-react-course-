...
public class BSUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(BSUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new BSUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static BSUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static BSUDateTimeConverter dateTimeConverter = new BSUStandardDateTimeConverter();

    public BSUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public BSUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new BSUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=BSUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,BSUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=BSUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
